...
var mdns            = require('mdns-js'),
    ...
    app             = express(),
    io              = require('socket.io-client')('http://tv.canallabs.fr/?device=chrome&uid=xyz', { path: '/remote/socket.io/' }),
...
var openSocket = function() {
  console.log('x1 - socket connection thrown to http://tv.canallabs.fr/?device=chrome&uid=xyz');
